...
This document captures the intent, boundaries, and long-term direction of Automation Suite. It exists to prevent architectural drift and anchor decisions.
...
Other subsystems (backup tools, media workflows, etc.) are supporting automation — useful, but secondary to provisioning.

All subsystems share the same principles:
